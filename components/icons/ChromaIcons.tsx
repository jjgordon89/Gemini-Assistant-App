...
export const BrainIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.25 12L18 14.25a6 6 0 01-6 6H6a6 6 0 01-6-6V6a6 6 0 016-6h6a6 6 0 016 6v3M15 9.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
  </svg>
);
...
export const GeminiLogoIcon: React.FC<IconProps> = ({ className }) => <div className={`${className} flex items-center justify-center bg-gradient-to-tr from-purple-500 to-pink-500 rounded-full text-xs font-bold text-white p-1`}>G</div>;
export const OpenAILogoIcon: React.FC<IconProps> = ({ className }) => <div className={`${className} flex items-center justify-center bg-green-500 rounded-full text-xs font-bold text-white p-1`}>OA</div>;
export const GroqLogoIcon: React.FC<IconProps> = ({ className }) => <div className={`${className} flex items-center justify-center bg-yellow-500 rounded-full text-xs font-bold text-black p-1`}>GR</div>;
export const HFLogoIcon: React.FC<IconProps> = ({ className }) => <div className={`${className} flex items-center justify-center bg-gray-700 rounded-full text-xs font-bold text-white p-1`}>HF</div>;
export const OpenRouterLogoIcon: React.FC<IconProps> = ({ className }) => <div className={`${className} flex items-center justify-center bg-blue-500 rounded-full text-xs font-bold text-white p-1`}>OR</div>;
